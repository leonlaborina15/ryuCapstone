...
?>
  <div class="header">
    ...
    <div class="header-links">
      <a href="customer_view_replies.php" class="dashboard-item <?php echo $current_page == 'customer_view_replies.php' ? 'active' : ''; ?>">View Messages</a>
      ...
      <a href="messages.php" class="dashboard-item <?php echo $current_page == 'messages.php' ? 'active' : ''; ?>">Send a Message</a>
      |
